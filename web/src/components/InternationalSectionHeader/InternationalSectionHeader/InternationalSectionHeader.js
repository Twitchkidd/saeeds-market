...
const InternationalSectionHeader = ({ internationalSectionHeader }) => {
      ...
      <div className="rw-segment">
        <header className="rw-segment-header">
          <h2 className="rw-heading rw-heading-secondary">
            InternationalSectionHeader {internationalSectionHeader.id} Detail
          </h2>
        </header>
        <table className="rw-table">
          <tbody>
            <tr>
              <th>Id</th>
              <td>{internationalSectionHeader.id}</td>
            </tr>
            <tr>
              <th>Text</th>
              <td>{internationalSectionHeader.text}</td>
            </tr>
            <tr>
              <th>With from</th>
              <td>{internationalSectionHeader.withFrom}</td>
            </tr>
            <tr>
              <th>Created at</th>
...
export default InternationalSectionHeader;
